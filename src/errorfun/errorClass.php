...
class ErrorClass
{
	...
	public function debug_back_trace()
	{
		return debug_backtrace();
	}

	public function debug_print_back_trace()
	{
		return debug_print_backtrace();
	}

	public function get_error_get_last()
	{
	 ...
	 */	
	public function set_error_reporting_nothing()
	{
		#禁止报告所有错误
		error_reporting(0);
	}

	public function set_error_reporting_all()
	{
		#报告所有错误
		error_reporting(E_ALL);
	}

	public function set_error_reporting_runing()
	{
		#报告运行时错误
		error_reporting(E_ERROR | E_WARNING | E_PARSE);
	}

	public function set_error_reporting_expect_notice()
	{
		#报告所有错误除了 E_NOTICE
